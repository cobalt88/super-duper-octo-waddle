...
This is just a testing ground for building a REST API, currently it does not serve a functional purpose. Eventually this will become either the base for the RecipEZ API or a place to simply test out some features for that API. 

 ![Alt text](./dist/teamPage.png)

 ## Installation Instructions

Currently there are no install instructions as this is not a fully developed API yet.


 ## Instructions/How To Use
 
This application is not currently intended for use. 
